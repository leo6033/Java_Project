...
public class ChatFrame extends JFrame{
    ...
    public void init(){
        ...
        paint.setBorder(BorderFactory.createEtchedBorder(new Color(0, 0, 0), new Color(0, 255, 0)));
        ...
        //保存屏幕按钮
        JButton saveBtn = new JButton(new ImageIcon("images/sendPic.png"));
        saveBtn.setMargin(new Insets(0,0,0,0));
        saveBtn.setToolTipText("保存图片");
    ...
    private void save() throws IOException {
        ...
        Image newImage = image.getScaledInstance(1100, 620, Image.SCALE_SMOOTH);
        BufferedImage myImage = new BufferedImage(1100,620,BufferedImage.TYPE_INT_RGB);
    ...
    /*画图*/
    public static void draw(Response response, JFrame jFrame){
        final Shape shape = (Shape)response.getData("Shape");
        shape.draw((Graphics2D) jFrame.getGraphics());
        list.add(shape);
    }
